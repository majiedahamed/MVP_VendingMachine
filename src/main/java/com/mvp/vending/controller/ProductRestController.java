...
public class ProductRestController {
    ...
    /**
     * Remove a specific product from a specific machine
     *
     * @param machineId the vending machine
     * @param productId the product
     * @return the product you have removed
     */
    @RequestMapping(method = RequestMethod.GET, value = "/{productId}/remove")
    Product remove(@PathVariable String machineId, @PathVariable Long productId) {
        this.validateMachine(machineId);
    ...
    Optional<Product> getProduct(@PathVariable String machineId, @PathVariable Long productId) {
        this.validateMachine(machineId);
